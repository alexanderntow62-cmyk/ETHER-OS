...
class GmailHttpClient {
  ...
  GmailHttpClient({required this.httpClient, required this.authorizedClient});
  ...
  Future<Map<String, dynamic>> getJson(
    ...
    final uri = Uri.https('gmail.googleapis.com', path, queryParameters);
  ...
  Future<Map<String, dynamic>> postJson(
    ...
    final uri = Uri.https('gmail.googleapis.com', path);
