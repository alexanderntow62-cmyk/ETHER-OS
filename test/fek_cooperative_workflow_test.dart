...
void main() {
  ...
  test('FEK cooperative workflow falls back to normal processing for non-business requests', () async {
  ...
  test('FEK cooperative workflow uses Business FEK for business requests', () async {
    final fek = EtherFEKCoordinator();
